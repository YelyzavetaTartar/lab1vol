...
namespace LibraryVolunteer.Controllers
{
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //return View(country);
            return RedirectToAction("Index", "Volunteers", new { id = country.CountryCode, name = country.CountryName });
        }
        ...
        public async Task<IActionResult> Create([Bind("CountryCode,CountryName")] Country country)
        {
